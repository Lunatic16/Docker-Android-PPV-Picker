  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.header}>
        ...
        {/*                                                                  */}
        {/* On Android TV the D-pad does not automatically route focus into  */}
        {/* a TextInput — it only fires onPress on the nearest focusable     */}
        {/* view. The Pressable wrapper intercepts that press and explicitly  */}
        {/* calls searchRef.current.focus(), which opens the keyboard and    */}
        {/* activates the input. The wrapper also carries its own focus ring */}
        {/* so the user sees the cursor land on the search bar.              */}
        <Pressable
          ...
          focusable={true}
          accessibilityRole="button"
          accessibilityLabel="Search filter input"
          style={[
            styles.searchRow,
        ...
        >
          ...
          <TextInput
            ...
            autoCorrect={false}
            autoCapitalize="none"
            // Must be false here — focus is owned by the Pressable wrapper
            // above so the TV remote's spatial focus engine lands on it.
            // The TextInput itself receives focus programmatically via ref.
            focusable={false}
          ...
          {query.length > 0 && (
            <Pressable
              ...
              style={({ focused }) => [
                styles.clearBtn,
                focused && styles.clearBtnFocused,
              ]}
              accessibilityRole="button"
